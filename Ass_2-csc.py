...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="MSU-IIT STUDENT", font=("Bahnschrift", 50,"bold"),bd=10, width = 35, bg="gray", fg="white")
        label.place(x=1,y=50)

        label = tk.Label(self, text="INFORMATION SYSTEM", font=("Bahnschrift", 50,"bold"),bd=10, width = 35, bg="gray", fg="white")
        label.place(x=1,y=150)

        label = tk.Label(self, text="Student: LYNN STEFANNY D. TALA", font=("Courier New", 12),fg="blue")
        label.place(x=1,y=570)
        
        home = tk.Label(self, text="HOME",font=("Arial",20,"bold"),bd=7, width = 20, bg="Black", fg="white")
        home.place(x=1,y=370)
        
        
        course = tk.Button(self, text="COURSES",font=("Arial",20),bd=0, width = 20, bg="orange", fg="white", command=lambda: controller.show(Courses))
        course.place(x=700,y=300)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Arial",20),bd=0, width = 20, bg="orange", fg="white", command=lambda: controller.show(Students))
        students.place(x=700,y=400)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Arial",18),bd=0, width = 10, bg="Red", fg="white", command=iExit)
        students.place(x=880,y=500)
        students.config(cursor= "hand2")
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="COURSES", font=("Times New Roman", 50,"bold"),fg="orange")
        ...
        home = tk.Button(self, text="HOME",font=("Arial",13,"bold"),bd=0, width = 10, bg="Black", fg="white", command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        ...
        self.lblccode = Label(self, font=("Arial", 12, "bold"), text="Course Code:", padx=5, pady=5)
        self.lblccode.place(x=125,y=144)
        self.txtccode = Entry(self, font=("Arial", 13), textvariable=Course_Code, width=31)
        self.txtccode.place(x=270,y=150)

        self.lblcname = Label(self, font=("Arial", 12,"bold"), text="Course Name:", padx=5, pady=5)
        self.lblcname.place(x=125,y=205)
        self.txtcname = Entry(self, font=("Arial", 13), textvariable=Course_Name, width=31)
        self.txtcname.place(x=270,y=210)
        
        self.SearchBar = Entry(self, font=("Arial", 11), textvariable=SearchBar_Var, bd=0,bg="Gray",width=35)
        ...
        self.adds = Button(self, text="ADD", font=('Arial', 11, ), height=1, width=10, bd=1, bg="Black", fg="white",command=add_course)
        self.adds.place(x=460,y=300)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Arial', 11), height=1, width=10, bd=1, bg="Black", fg="white", command=update_course) 
        self.update.place(x=460,y=360)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Arial', 11), height=1, width=10, bd=1, bg="Orange", fg="white", command=clear)
        self.clear.place(x=460,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Arial', 11), height=1, width=10, bd=1, bg="Red", fg="white", command=delete_course)
        self.delete.place(x=460,y=480)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Arial', 11, 'bold'),bd=0, bg= "orange", fg="white", command=search_course)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Arial', 11, 'bold'), height=1, width=11, bg="beige", fg="gray", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="REGISTRATION FORM ", font=("Arial", 50,"bold"),fg="orange")
        label.place(x=130,y=20)
        ...
        self.lblid = Label(self, font=("Arial", 12,"bold"), text="ID Number:", padx=5, pady=5)
        self.lblid.place(x=125,y=144)
        self.txtid = Entry(self, font=("Arial", 13), textvariable=Student_ID, width=33)
        self.txtid.place(x=255,y=150)

        self.lblname = Label(self, font=("Arial", 12,"bold"), text="Name:", padx=5, pady=5)
        self.lblname.place(x=125,y=205)
        self.txtname = Entry(self, font=("Arial", 13), textvariable=Student_Name, width=33)
        self.txtname.place(x=255,y=210)
        
        self.lblc = Label(self, font=("Arial", 12,"bold"), text="Course Code:", padx=5, pady=5)
        ...
        self.lblyear = Label(self, font=("Arial", 12,"bold"), text="Year Level:", padx=5, pady=5)
        ...
        self.lblgender = Label(self, font=("Arial", 13,"bold"), text="Gender:", padx=5, pady=5)
        self.lblgender.place(x=125,y=361)
        self.txtgender = ttk.Combobox(self, value=["Male", "Female"], font=("Arial", 13), state="readonly", textvariable=Student_Gender, width=28)
        self.txtgender.place(x=255,y=366)

        self.SearchBar = Entry(self, font=("Arial", 11), textvariable=SearchBar_Var, bd=0,bg="Gray", width=31)
        self.SearchBar.place(x=876,y=110)
        ...
        self.add = Button(self, text="REGISTER", font=('Arial', 11), height=1, width=10, bd=1,  bg="Black", fg="white", command=add_stud)
        self.add.place(x=150,y=420)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Arial', 11), height=1, width=10, bd=1, bg="Black", fg="white", command=update_stud)
        ...
        self.delete = Button(self, text="DELETE", font=('Arial', 11), height=1, width=10, bd=1, bg="Red", fg="white", command=delete_stud)
        self.delete.place(x=450,y=420)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Arial', 11, 'bold'),bd=0, bg= "orange", fg="white", command=search_stud)
        self.search.place(x=1140,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Arial', 11, 'bold'), height=1, width=11,  bg="Beige", fg="gray",command = display_stud)
        self.display.place(x=575,y=105)
        self.display.config(cursor= "hand2")
